...
<c:set var="lastContentsStatement" value="select * from [jsonimportnt:tile] as contents where ISDESCENDANTNODE(contents,'${folderPath}') ${queryConstraint} order by contents.[jcr:title] asc"/>
